...
public class QueryBuilderTest {
    ...
    public void testBuildInsertQuery() {
        ...
        String insertQuery =
                QueryBuilder.buildInsertQuery("mytable", columns, AbstractInsertUpdateDAOImpl.ID_COLUMN_NAME, false);
        assertEquals("INSERT INTO mytable(first_name,last_name) VALUES(?,?)", insertQuery);

        insertQuery =
                QueryBuilder.buildInsertQuery("mytable", columns, AbstractInsertUpdateDAOImpl.ID_COLUMN_NAME, true);
    ...
    public void testBuildUpdateQuery() {
        ...
        columns.add("last_name");
        String updateQuery =
                QueryBuilder.buildUpdateQuery("mytable", columns, AbstractInsertUpdateDAOImpl.ID_COLUMN_NAME);
