 ...
 *
 * @param <E>
 *         A DTO class that implements {@link IdPrivateKeyDTO}.
 */
public abstract class AbstractInsertUpdateDAOImpl<E extends IdPrivateKeyDTO> extends DAOImpl
        implements AbstractInsertUpdateDAO<E> {
    ...
    public AbstractInsertUpdateDAOImpl(Properties props, AbstractDBUtility dbutil)
    ...
    public void setDataSource(DataSource dataSource) {
        ...
        columnNames = new ArrayList<>(columnNamesWithoutId);
    ...
    public long insert(E obj) {
        long newId = simpleInsert.insertAndReturnId(insertQuery, ID_COLUMN_NAME, columnNamesWithoutId,
...
//    }
    ...
    private List<E> doSelectWithOrderBy(String query) {
    ...
    private List<E> doSelect(String query) {
...
//    }
    ...
    /**
     * Returns a {@link Map} object filled with the field data from the given DTO
     * object. The parameter names set in the Map object must correspond to the
     ...
     *         this method.
     * @return A {@link Map} object filled with the parameters of the dtoObj.
     */
     ...
     * instance.
     *
     * @return A Spring JDBC {@link TypedRowMapper}.
     */
    ...
    protected static Date getNullableDateColumn(ResultSet rs, String columnName)
            throws SQLException {
